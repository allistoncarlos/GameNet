...
public struct DashboardResponseDTO: Codable {
    // MARK: Public

    public var boughtByYear: [BoughtGamesByYearTotalResponseDTO]?
    public var finishedByYear: [FinishedGameByYearTotalResponseDTO]?
    public var playingGames: [PlayingGameResponseDTO]?
    public var physicalDigital: PhysicalDigitalResponseDTO?
    public var gamesByPlatform: PlatformGamesResponseDTO?
