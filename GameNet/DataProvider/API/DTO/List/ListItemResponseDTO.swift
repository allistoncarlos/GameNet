...
public struct ListItemResponseDTO: Identifiable, Codable {
...
public struct ListGameResponseDTO: Identifiable, Codable {
    public var id: String?
    public var name: String
    public var creationDate: Date?
    public var games: [ListItemResponseDTO]?
